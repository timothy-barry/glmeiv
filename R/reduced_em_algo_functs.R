...
#' fit_univariate <- run_reduced_em_algo(m, g, m_fitted, g_fitted,
#' m_pert_guess, g_pert_guess, pi_guess, m_fam, g_fam)
run_reduced_em_algo <- function(m, g, m_fitted, g_fitted, m_pert_guess, g_pert_guess, pi_guess, m_fam, g_fam, ep_tol = 0.5 * 1e-4, max_it = 50, min_it = 3) {
  set.seed(4)
...
run_e_step_reduced <- function(m, g, m_fitted, g_fitted, curr_m_perturbation, curr_g_perturbation, curr_pi, m_fam, g_fam) {
...
run_m_step_univariate <- function(m, g, m_fitted, g_fitted, curr_Ti1s, m_fam, g_fam) {
